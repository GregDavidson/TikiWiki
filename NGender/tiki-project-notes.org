...
** Categorical Imperative Project

Purpose: Leverage Default Groups their Default Categories to
give users control over objects they create and/or objects
associated with their default category.
...
-- or even better as as an upsert!!
#+END_SRC
