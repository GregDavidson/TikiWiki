...
*** Where am I using groups_category_model_permissions to set permissions?

Need to add a procedure to tiki-ngender-schema.sql which
sets category/group permissions according to TABLE
groups_category_model_permissions.
