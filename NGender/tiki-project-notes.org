...
Something is wrong with admin users
- I only got one page and it ended in Windy!
- There appeared to be no method of getting to any more!
- Sorting by other fields got to the other users :-(

The tracing code I have in is claiming that ZObserver is NOT a Steward!

I should have an user_is_steward(user_id) function and I should make sure that I'm not using 'Stewards" hither and yon.  Ideally I'd have feature prefs for the things currently hardwired into feature_ngender_stewards:
- feature Group meaning Stewards
- prefix or format string for User Groups
- parent group of User Groups
- How to encode User Default Category?
